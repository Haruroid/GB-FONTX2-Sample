...
void (*_HR_FONTX2_readHFont)(uint16_t offset,uint16_t size,uint8_t* out);
void (*_HR_FONTX2_readZFont)(uint16_t offset,uint16_t size,uint8_t* out);

bool HR_FONTX2_init(void (*readHFont)(uint16_t offset,uint16_t size,uint8_t* out), void (*readZFont)(uint16_t offset,uint16_t size,uint8_t* out),
...
uint8_t HR_FONTX2_writeChar(uint16_t c, uint16_t xs, uint16_t ys,
	...
	uint32_t offset = 0;
	uint8_t lsize = 0;
	void (*readFont)(uint16_t offset,uint16_t size,uint8_t* out) = NULL;
	fontxmeta_t *meta;
